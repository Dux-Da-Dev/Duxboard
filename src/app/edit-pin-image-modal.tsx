...
import { getModelInstructions, regeneratePinImageWithImageInput } from './actions'
...
export default function EditPinImageModal({ pin, isOpen, onClose }: EditPinImageModalProps) {
  ...
  const handleGenerateSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const result = await regeneratePinImageWithImageInput(pin.id, pin.image_url, prompt, instructionProfileId)
